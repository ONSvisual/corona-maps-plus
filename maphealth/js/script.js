...
if(Modernizr.webgl) {
	...
	// function ready (error, data, config, geog){
		...
		layernames = ["oneperp","onep65p","lmlotp","lmlot65p","badhp","onedisp","onediscp"];

		layername = "oneperp";

		hoverlayernames = ["oneperp","onep65p","lmlotp","lmlot65p","badhp","onedisp","onediscp"];
		hoverlayername = "oneperp";

		secondvars = ["oneper","onep65","lmlot","lmlot65","badh","onedis","onedisc"];
		secondvar = "oneper";
		...
		map.on('load', function() {
			...
			map.addLayer({
				...
				"source": {
					...
					"tiles": ["https://cdn.ons.gov.uk/maptiles/t29/boundaries/{z}/{x}/{y}.pbf"],
				},
				"minzoom": 9,
				"maxzoom": 20,
			...
			map.addLayer({
				...
				map.addLayer({
					...
					"source": {
						...
						"tiles": ["https://cdn.ons.gov.uk/maptiles/t29/tiles/{z}/{x}/{y}.pbf"],
					},
